...
window.plugins.socialsharing.shareViaFacebook('Message via Facebook', 'www/icon.png' /* img */, 'http://www.dotter.com.br'/* url */,function() {alert('share ok');}, function(errormsg){alert(errormsg)});	
}
